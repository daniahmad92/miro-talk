...
const signalingServerPort = 3300; // must be the same to server.js PORT
...
function welcomeUser() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            let message = {
                email: '',
                subject: 'Please join our Meeting',
...
function showAbout() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: '<strong>Live Class</strong>',
        html: `
        <br/>
        <div id="about">
            dikembangkan oleh Myedulab          
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
